...
e tipo dad embalagem. Especificamente, picolés normais possuem um conjunto de aditivos nutritivos (vitaminas ou sais
minerais) cada um com nome e fórmula química; e picolés aio leite contêm um conjunto de conservantes, cada um com nome e
descrição. Os oid stipos de picolés são vendidos em lotes exclusivos (ou normais, ou ao leite) para os revendedores e
...
armazena-se di revendedor o CNPJ e a razão social. Deseja-se obter relatórios sobre as vendas mensais dos picolés de
