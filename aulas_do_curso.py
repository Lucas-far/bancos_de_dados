...
def aula_5():
    ...
    "NoSQL"            # Not only structured query language - Linguagem não apenas de consulta estruturada
    "SGBD"             # Sistema Gerenciador de banco de dados (tanto para SQL quanto NoSQL)
    "SQL vantagens"    # dados sob gerenciamento de validação, verificação, integridade, controle, recuperação, etc
    "SQL desvantagem"  # Pobreza em escalabilidade e particionamento
    "NoSQL vantagens"  # mais performance, por ausência de (tabelas == linhas e colunas)
    "NoSQL vantagens"  # mais performance = boa escalabilidade, particionamento e replicação de dados

# Bdds relacionais conhecidos
def aula_6():
...
# Bdds não apenas relacionais conhecidos
def aula_7():
...
"Aulas que precisam ser assistidas novamente"
def aula_11():
